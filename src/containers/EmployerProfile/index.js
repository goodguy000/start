      ...
      <Fragment>
        ...
        <section className="detail-desc advance-detail-pr gray-bg">
          <div className="container white-shadow">
            <div className="row">
              <div className="detail-pic"><img src="assets/img/can-2.png" className="img" alt /><a href="#" className="detail-edit" title="edit"><i className="fa fa-pencil" /></a></div>
              <div className="detail-status"><span>Active Now</span></div>
            </div>
            <div className="row bottom-mrg">
              <div className="col-md-12 col-sm-12">
                <div className="advance-detail detail-desc-caption">
                  <h4>Adam Declizer</h4><span className="designation">CEO &amp; Founder</span>
                  <ul>
                    <li><strong className="j-view">742</strong>Job Post</li>
                    <li><strong className="j-applied">570</strong>Job Like</li>
                    <li><strong className="j-shared">210</strong>Job Shared</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div className="full-card">
                <div className="deatil-tab-employ tool-tab">
                  ...
                  <div className="tab-content">
                    ...
                    {/* End Address Sec */}
                    {/* Start Job List */}
                    <div id="post-job" className="tab-pane fade">
                      <h3>You have 22 job post</h3>
                      <div className="row">
                        <article>
                          <div className="mng-company">
                            <div className="col-md-2 col-sm-2">
                              <div className="mng-company-pic"><img src="assets/img/com-1.jpg" className="img-responsive" alt /></div>
                            </div>
                            <div className="col-md-5 col-sm-5">
                              <div className="mng-company-name">
                                <h4>Autodesk <span className="cmp-tagline">(Software Company)</span></h4><span className="cmp-time">10 Hour Ago</span></div>
                            </div>
                            ...
                            <div className="col-md-1 col-sm-1">
                              <div className="mng-company-action"><a href="#"><i className="fa fa-edit" /></a><a href="#"><i className="fa fa-trash-o" /></a></div>
                            </div>
                          </div>
                        ...
                        <article>
                          <div className="mng-company">
                            <div className="col-md-2 col-sm-2">
                              <div className="mng-company-pic"><img src="assets/img/com-2.jpg" className="img-responsive" alt /></div>
                            </div>
                            <div className="col-md-5 col-sm-5">
                              <div className="mng-company-name">
                                <h4>Google <span className="cmp-tagline">(Software Company)</span></h4><span className="cmp-time">10 Hour Ago</span></div>
                            </div>
                            <div className="col-md-4 col-sm-4">
                              <div className="mng-company-location">
                                <p><i className="fa fa-map-marker" /> Street #210, Make New London</p>
                        ...
                        <article>
                          <div className="mng-company">
                            <div className="col-md-2 col-sm-2">
                              <div className="mng-company-pic"><img src="assets/img/com-3.jpg" className="img-responsive" alt /></div>
                            </div>
                            <div className="col-md-5 col-sm-5">
                              <div className="mng-company-name">
                                <h4>Honda <span className="cmp-tagline">(Motor Agency)</span></h4><span className="cmp-time">10 Hour Ago</span></div>
                            </div>
                            <div className="col-md-4 col-sm-4">
                              <div className="mng-company-location">
                                <p><i className="fa fa-map-marker" /> Street #210, Make New London</p>
                        ...
                        <article>
                          <div className="mng-company">
                            <div className="col-md-2 col-sm-2">
                              <div className="mng-company-pic"><img src="assets/img/com-4.jpg" className="img-responsive" alt /></div>
                            </div>
                            <div className="col-md-5 col-sm-5">
                              <div className="mng-company-name">
                                <h4>Microsoft <span className="cmp-tagline">(Software Company)</span></h4><span className="cmp-time">10 Hour Ago</span></div>
                            </div>
                            <div className="col-md-4 col-sm-4">
                              <div className="mng-company-location">
                                <p><i className="fa fa-map-marker" /> Street #210, Make New London</p>
                        ...
                        <article>
                          <div className="mng-company">
                            <div className="col-md-2 col-sm-2">
                              <div className="mng-company-pic"><img src="assets/img/com-5.jpg" className="img-responsive" alt /></div>
                            </div>
                            <div className="col-md-5 col-sm-5">
                              <div className="mng-company-name">
                                <h4>Skype <span className="cmp-tagline">(Software Company)</span></h4><span className="cmp-time">10 Hour Ago</span></div>
                            </div>
                            <div className="col-md-4 col-sm-4">
                              <div className="mng-company-location">
                                <p><i className="fa fa-map-marker" /> Street #210, Make New London</p>
                        ...
                        <article>
                          <div className="mng-company">
                            <div className="col-md-2 col-sm-2">
                              <div className="mng-company-pic"><img src="assets/img/com-6.jpg" className="img-responsive" alt /></div>
                            </div>
                            <div className="col-md-5 col-sm-5">
                              <div className="mng-company-name">
                                <h4>Virtue <span className="cmp-tagline">(Development Company)</span></h4><span className="cmp-time">10 Hour Ago</span></div>
                            </div>
                            <div className="col-md-4 col-sm-4">
                              <div className="mng-company-location">
                                <p><i className="fa fa-map-marker" /> Street #210, Make New London</p>
                        ...
                        <article>
                          <div className="mng-company">
                            <div className="col-md-2 col-sm-2">
                              <div className="mng-company-pic"><img src="assets/img/com-7.jpg" className="img-responsive" alt /></div>
                            </div>
                            <div className="col-md-5 col-sm-5">
                              <div className="mng-company-name">
                                <h4>Twitter <span className="cmp-tagline">(Social Media Company)</span></h4><span className="cmp-time">10 Hour Ago</span></div>
                            </div>
                            <div className="col-md-4 col-sm-4">
                              <div className="mng-company-location">
                                <p><i className="fa fa-map-marker" /> Street #210, Make New London</p>
                      ...
                      <div className="row">
                        <div className="col-md-4 col-sm-4">
                          <div className="manage-cndt">
                            ...
                            </div><a href="#" title className="cndt-profile-btn">View Profile</a>
                          </div>
                        </div>
                        <div className="col-md-4 col-sm-4">
                          <div className="manage-cndt">
